...
public class RegistrationNumbersForColour {
	
	public void searchRegistrationNumbersForColour(String input, String operationMode) {
    	...
    	System.out.println(ParkingLotModel.getColourToRegistrationNumbers().get(carColour).toString().replace(ParkingLotConstants.OPEN_SQUARE_BRACKET, 
